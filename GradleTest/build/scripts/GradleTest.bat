...
set CLASSPATH=%APP_HOME%\lib\GradleTest.jar;%APP_HOME%\lib\commons-math3-3.6.1.jar;%APP_HOME%\lib\json-20171018.jar;%APP_HOME%\lib\json-simple-1.1.jar;%APP_HOME%\lib\jackson-databind-2.1.1.jar;%APP_HOME%\lib\jackson-annotations-2.1.2.jar;%APP_HOME%\lib\jackson-core-2.1.2.jar;%APP_HOME%\lib\guava-23.0.jar;%APP_HOME%\lib\jsr305-1.3.9.jar;%APP_HOME%\lib\error_prone_annotations-2.0.18.jar;%APP_HOME%\lib\j2objc-annotations-1.1.jar;%APP_HOME%\lib\animal-sniffer-annotations-1.14.jar

@rem Execute GradleTest
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GRADLE_TEST_OPTS%  -classpath "%CLASSPATH%" test.TestFile %CMD_LINE_ARGS%
